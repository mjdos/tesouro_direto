    ...
    return {
        init: function() {
            ...
            a.push(FormValidation.formValidation(i, { 
                ...
                fields: { 
                    banco_id: { validators: { notEmpty: { message: "Selecione o Banco." } } }, 
                    agencia: { validators: { notEmpty: { message: "Preencha o campo Agência." } } }, 
                    conta_corrente: { validators: { notEmpty: { message: "Preencha o campo Conta Corrente." } } } }, 
                    plugins: { trigger: new FormValidation.plugins.Trigger, bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) } })), 
