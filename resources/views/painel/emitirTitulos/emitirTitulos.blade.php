                            ...
                            <div class="row pt-3">
                                <div class="col-sm">
                                    <div class="col-4">
                                        ...
                                        <input class="form-control form-control-solid" type="text" name="valor" id="valor">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    emitirButton.addEventListener('click', () => {
        ...
        const valorComZeros = valor * Math.pow(10, 18);

        contract.methods.emitirTitulo(idExterno, carteiraDestino, quantidade, valor).send({ from: accounts[0] })
            .then(response => {
