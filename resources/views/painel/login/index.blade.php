                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <img src="{{ url ('assets/imagens/avatar.png') }}" alt="image">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bold">Detalhes</div>
                                <!--begin::Badge-->
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                        ...
                                        <tbody class="fs-6 fw-semibold text-gray-600">
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14332</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14912</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15492</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15100</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#14384</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15804</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15186</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                            ...
                                            <tr>
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-600 text-hover-primary mb-1">#15934</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">**** 4840</td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 6600</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 2304</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
