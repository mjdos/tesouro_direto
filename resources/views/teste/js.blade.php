<script>
    ...
    fetch(` http://localhost:8000/api/grafico-teste?endpoint=https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1m&limit=1000`)
        .then(res => res.json())
        .then(data => {
    ...
    //Dynamic Chart
    const socket = io.connect(' http://localhost:8000/api/grafico-teste');
